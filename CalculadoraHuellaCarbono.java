...
public class CalculadoraHuellaCarbono {
    public void mostrarVentana() {
        ...
        // aqui se crea la ventana de la calculadora
        ...
        panelPrincipal.setBackground(new Color(204, 255, 204)); // Verde clarito (hay que ponerlo de fondo y cambiarlo)
        panelPrincipal.setLayout(new BoxLayout(panelPrincipal, BoxLayout.Y_AXIS));

        // componentes visuales para las preguntas
        ...
        JTextField txtRespuesta1 = new JTextField(10); // campo de respuesta
        ...
        JTextField txtRespuesta2 = new JTextField(10); // campo de respuesta
        ...
        JTextField txtRespuesta3 = new JTextField(10); // campo de respuesta
        ...
        JTextField txtRespuesta4 = new JTextField(10); // campo de respuesta
        ...
        btnCalcular.addActionListener(e -> {
            ...
            // para obtener las respuestas del usuario
            ...
            // Abrir la tercera ventana (la de consejos)
